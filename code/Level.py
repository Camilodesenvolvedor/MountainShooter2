...
class Level:
    ...
    def run(self):
        ...
        while True:
            ...
            # printed text
            self.level_text(14, f'{self.name} - Timeout: {self.timeout / 1000 :.1}s', C_WHITE, (10, 5))
            self.level_text(14, f'fps: {clock.get_fps() :.0f}', C_WHITE, (10, WIN_HEIGHT - 35))
            self.level_text(14, f'entidades: {len(self.entity_list)}', C_WHITE, (10, WIN_HEIGHT - 20))
            pygame.display.flip()
            # Collisions
            EntityMediator.verif_collision(entity_list=self.entity_list)
            EntityMediator.verif_health(entity_list=self.entity_list)
        pass
